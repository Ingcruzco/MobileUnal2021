        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(lat.getVisibility()==View.VISIBLE){
                    currenLat=Double.parseDouble(lat.getText().toString());
                    currentLong=Double.parseDouble(lng.getText().toString());
                }
                int i =spType.getSelectedItemPosition();
                String url="https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=" + currenLat + "," + currentLong +
                        "&radius=8000" +
            ...
            public void onSuccess(Location location) {
                supportMapFragment.getMapAsync(new OnMapReadyCallback() {
                    ...
                    public void onMapReady(@NonNull GoogleMap googleMap) {
                        ...
                        LatLng latLng=new LatLng(currenLat,currentLong);
