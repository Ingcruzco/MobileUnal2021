...
public class DirectoryInput extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        registerBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               if (db.insertCompany(name.getText().toString(),
                        url.getText().toString(),
                        phone.getText().toString(),
                        email.getText().toString(),
                        clasification.getText().toString(),
                        products.getText().toString())){
                   Toast.makeText(getApplicationContext(), "Se insertó exitosamente el registro", Toast.LENGTH_SHORT).show();
               }else{
                   Toast.makeText(getApplicationContext(), "Hubo un problema la insertar el registro", Toast.LENGTH_SHORT).show();
               }
            }
        });
